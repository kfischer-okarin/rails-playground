...
class WorkTimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_time" do
    assert_difference("WorkTime.count") do
      post work_times_url, params: { work_time: { date: @work_time.date, duration: @work_time.duration, start_time: @work_time.start_time, user_id: @work_time.user_id } }
    end
  ...
  test "should update work_time" do
    patch work_time_url(@work_time), params: { work_time: { date: @work_time.date, duration: @work_time.duration, start_time: @work_time.start_time, user_id: @work_time.user_id } }
